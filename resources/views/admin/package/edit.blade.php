...
@section('admin_content')
    ...
    <form action="{{ url('admin/package/update/'.$package->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="p_seq" class="form-control" value="{{ $package->p_seq }}" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <img src="{{ asset('public/uploads/'.$package->p_photo) }}" alt="" class="w_300">
                    </div>
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <textarea name="p_description_short" class="form-control h_100" cols="30" rows="10">{{ $package->p_description_short }}</textarea>
                </div>
                <div class="form-group">
                    <label for="">FAQ'S</label>
                    <textarea name="p_description" class="form-control editor" cols="30" rows="10">{{ $package->p_description }}</textarea>
                </div>
                 <div class="form-group">
                    <label for="">Itinerary</label>
                    <textarea name="p_itinerary" class="form-control editor" cols="30" rows="10">{{ $package->p_itinerary }}</textarea>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" name="p_min_pack" class="form-control" value= "{{ $package->p_min_pack }}">
                </div>
                <div class="form-group">
                    <label for="">Best time to visit</label>
                   <input type="text" name="p_best_time_to_visit" class="form-control" value="{{$package->p_best_time_to_visit}}">
                </div>
                <div class="form-group">
                    <label for="">Trip Level</label>
        <input type="text" name="p_trek_level" class="form-control" value="{{ $package->p_trek_level }}">
                </div>
                <div class="form-group">
             <label for="">Fixed Departure Dates</label>
                <input type="text" name="p_fix_departure_date" class="form-control" value="{{$package->p_fix_departure_date}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="p_policy" class="form-control editor" cols="30" rows="10">{{ $package->p_policy }}</textarea>
                </div>
                <div class="form-group">
                    <label for="">Terms</label>
                    <textarea name="p_terms" class="form-control editor" cols="30" rows="10">{{ $package->p_terms }}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="destination_id" class="form-control select2">
                        @foreach($destination as $row)
                            <option value="{{ $row->id }}" @if($row->id == $package->destination_id) selected @endif>{{ $row->d_name }}</option>
                        @endforeach
                    </select>
                </div>
                                <div class="form-group">
                    ...
                    <select name="services_id" class="form-control select2">
                        @foreach($service as $row)
                            <option value="{{ $row->id }}" @if($row->id == $package->services_id) selected @endif>{{ $row->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="seo_meta_description" class="form-control h_100" cols="30" rows="10">{{ $package->seo_meta_description }}</textarea>
                </div>
