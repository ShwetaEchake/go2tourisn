...
Route::get('category', [ServiceControllerForFront::class,'index'])->name('front.category');
...
Route::group(['prefix'=>'admin/page_home_update'], function() {
    ...
    Route::post('/featured_package', [PageHomeController::class,'update_featured_package']);
...
Route::match(['get','post'],'/weather',[HomeController::class,'weather'] )->name("weather"); 
