...
class ServiceController extends Controller
{
    ...
    public function detail($slug)
    {
	  ...
	  $packages = DB::table('packages')->where('services_id', $service_detail->id)->orderBy('p_seq','ASC')->get();
       
        if(!$service_detail) {
            return abort(404);
        }
        return view('pages.service_detail', compact('g_setting','service_detail','service_items','packages'));
    }
}
