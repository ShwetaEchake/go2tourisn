...
class PackageController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.package.create', compact('destination','services'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'p_price' => 'required',
            'p_photo' => 'required|image|mimes:jpeg,png,jpg,gif'
        ],
        [],
        [
            'p_name' => "Package Name",
            'p_seq' => "Package Sequence No.",
            'p_slug' => "Package Slug",
        ...
        $final_name = 'package-main-photo-'.uniqid().'.'.$ext;
    ...
    public function edit($id)
    {
        ...
        return view('admin.package.edit', compact('package', 'destination','service'));
    }
    ...
    public function photostore(Request $request)
    {
        ...
        $final_name = 'package-photo-'.uniqid().'.'.$ext;
