...
$traveller->traveller_country= '';
$traveller->traveller_address = '';
$traveller->traveller_state= '';
$traveller->traveller_city = '';
$traveller->traveller_zip = '';
 $traveller->traveller_name=$request->traveller_name;
 $traveller->traveller_email=$request->traveller_email;
 $traveller->traveller_password=Hash::make($request->traveller_password);
 $traveller->traveller_status="Active"; 
 $traveller->traveller_token=$token ;
 $traveller->save();
